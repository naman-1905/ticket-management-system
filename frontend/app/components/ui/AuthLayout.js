...
export default function AuthLayout({ title, subtitle, children, footer }) {
  return (
    <div className="relative flex min-h-[calc(100dvh-5rem)] items-center justify-center px-4 py-8 sm:py-12">
      ...
      <ThemeToggle className="absolute right-4 top-3 z-10 sm:top-4" />
